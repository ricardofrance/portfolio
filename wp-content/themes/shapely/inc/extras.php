					...
					<div
						...
						<h3 class="page-title" <?php echo $header_color ? 'style="color:#' . esc_attr( $header_color ) . '"' : '' ?>>
							...
							if ( is_home() ) {
								...
								echo ( is_post_type_archive( 'jetpack-portfolio' ) ) ? esc_html__( 'Portifólio', 'shapely' ) : get_the_archive_title();
							} else {
								echo ( is_singular( 'jetpack-portfolio' ) ) ? esc_html__( 'Portifólio', 'shapely' ) : get_the_title();
							} ?>
						</h3>
					</div>
				<?php endif; ?>
